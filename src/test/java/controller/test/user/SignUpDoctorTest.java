...
public class SignUpDoctorTest {
   ...
   public void SignUp_EMAIL_FACEBOOK_GPLUS() throws UnirestException {
      ...
      String expectResponse = "{\"user\":{\"userId\":" + id + ",\"specialties\":[],\"religion\":\"Religion\",\"longitude\":\"" + longitude.toString() + "\",\"latitude\":\"" + latitude.toString() + "\",\"consultationFee\":0,\"dateOfBirth\":1231797600000,\"deviceId\":\"307564180daba553\",\"deviceModel\":\"Meizu m2 note\",\"email\":\"" + email + "\",\"gender\":\"male\",\"isFullUserProfile\":false,\"languages\":[],\"imageUrl\":\"http://www.sande.cl/Images/Sitio/loginnew2.png\",\"fullName\":\"Alex Maximov\",\"locale\":\"ru_RU\",\"mobile\":\"77777777777\",\"osType\":\"android\",\"osVersion\":\"22\",\"universities\":[],\"rating\":0,\"role\":\"DOCTOR\",\"timeZoneId\":\"Europe/Kiev\",\"versionCode\":\"1\",\"loginTypes\":[{\"loginMode\":\"EMAIL\"},{\"loginMode\":\"FACEBOOK\"},{\"loginMode\":\"GPLUS\"}],\"title\":\"Dr\"},\"status\":true,\"statusCode\":200,\"sessionToken\":\"" + sessionToken + "\",\"message\":\"Sign Up successful\"}";
      JsonNode expectResponseBody = new JsonNode(expectResponse);
