...
public class SignUpPatientTest {
   ...
   public void SignUp_EMAIL_FACEBOOK_GPLUS() throws UnirestException {
      ...
      String expectResponse = "{\"user\":{\"userId\":" + id + ",\"consultationFee\":0,\"languages\":[{\"language\":\"Arabic\"},{\"language\":\"English\"}],\"dateOfBirth\":488160000000,\"email\":\"" + email + "\",\"imageUrl\":\"http://www.sande.cl/Images/Sitio/loginnew2.png\",\"fullName\":\"Alex Test\",\"latitude\":\"" + latitude + "\",\"longitude\":\"" + longitude + "\",\"rating\":0,\"role\":\"PATIENT\",\"loginTypes\":[{\"loginMode\":\"EMAIL\"},{\"loginMode\":\"FACEBOOK\"},{\"loginMode\":\"GPLUS\"}],\"identificationCard\":\"Identification Card\",\"insuranceCompany\":\"Insurance Company\",\"occupation\":\"Occupation\",\"streetAddress\":\"Street Address\",\"religion\":\"Religion\"},\"sessionToken\":\"" + sessionToken + "\",\"status\":true,\"statusCode\":200,\"message\":\"Sign Up successful\"}";
      JsonNode expectResponseBody = new JsonNode(expectResponse);
